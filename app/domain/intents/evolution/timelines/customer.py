"""
HunterOS Engage V1 - Customer Intent Timeline Builder
Projects customer-level intent timelines from historical snapshots and events.
"""
...
class CustomerTimelineBuilder(AbstractTimelineBuilder):
    """
    Builds chronological intent timelines for Customer entities.
    """

    def __init__(self):
        super().__init__(entity_type=EntityType.CUSTOMER)
    ...
    def build_timeline(
        ...
        if events:
            # Last event determines latest current_state
        ...
        return IntentTimeline(
            ...
            metadata={"total_snapshots": len(sorted_snaps)},
        )
